...
public class Tela implements ActionListener
{
    ...
    public Tela()
    {
        JFrame frame = new JFrame("Calcular Horas de Trabalho");
		frame.setVisible(true);
		frame.setSize(720, 280);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		frame.setLayout(null);
		labelNome = new JLabel("Hora de Início: ");
		labelEndereco = new JLabel("Hora de Almoço Saída: ");
		labelCidade = new JLabel("Hora de Almoço Volta: ");
		
		labelNome.setBounds(10,10,130,20);
		labelEndereco.setBounds(10,50,140,20);
		labelCidade.setBounds(10,90,140,20);

		textFieldNome = new JTextField(10);
		textFieldEndereco = new JTextField(10);
		textFieldCidade = new JTextField(10);

		textFieldNome.setBounds(145,10,80,20);
		textFieldEndereco.setBounds(145,50,80,20);
		textFieldCidade.setBounds(145,90,80,20);
